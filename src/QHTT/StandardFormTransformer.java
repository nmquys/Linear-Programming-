...
public class StandardFormTransformer extends JFrame {
    ...
    // Chuyển đổi sang dạng chuẩn, xử lý đầy đủ dấu =, <=, thêm biến slack
    ...
    public void showStandardModel(StandardLPModel _model) {
        ...
        for (int j = 0; j < _model.objectiveCoeffs.length; j++)
        {
            ...
            if (_model.isMax) value *= -1;
            //double coeff = _model.isMax ? _model.objectiveCoeffs[j] : -_model.objectiveCoeffs[j];
            tableData[0][j] =  value;
